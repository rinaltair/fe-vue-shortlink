  ...
  <li class="comment-item">
    <div class="comment-main">
      ...
      <div class="comment-info">
        ...
        <div class="btn-text" @click="toggleReply(comment.id)">Reply</div>
      </div>
    </div>
    ...
    <form v-if="showReplyForm === comment.id" @submit="handleSubmit">
      <div>
        <input v-model="replyAuthor" placeholder="Your name" required />
        <textarea v-model="replyContent" placeholder="Your reply" required></textarea>
