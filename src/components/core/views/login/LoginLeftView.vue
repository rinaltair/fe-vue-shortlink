<!-- Left background for Login/Register/Forgot Password -->
<template>
...
<script setup lang="ts">
  ...
  // Define props
  defineProps<{
    hideContent?: boolean // Whether to hide content and only show logo
  }>()
</script>
...
<style lang="scss" scoped>
  ...
  .login-left-view {
    ...
    @media only screen and (max-width: $device-ipad-pro) {
      ...
      height: auto;
      padding: 0;
      // Hide background and other content; keep only logo
  ...
  .dark .login-left-view {
    ...
    // Squares group dark adjustments
    .squares-group {
      .square {
        box-shadow: none;
