<template>
  <div class="card art-custom-card" style="height: 27.8rem">
    <div class="card-header">
      ...
      <p class="subtitle">This Month's Sales</p>
    </div>
    <div class="table">
      <el-scrollbar style="height: 21.55rem">
        ...
        >
          <template #default>
            <el-table-column label="Product" prop="product" width="220px">
            ...
            <el-table-column label="Sales Trend" width="240">
              <template #default="scope">
                <el-progress
...
<script setup lang="ts">
  ...
  // Get stock status text by level
  ...
  // Get stock status class by level
