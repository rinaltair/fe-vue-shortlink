<template>
  <div class="page-content">
    <h1 class="title">Message Wall</h1>
    <p class="desc">Every message captures your thoughts and becomes a cherished memory.</p>
...
<script setup lang="ts">
  ...
  const clickItem = ref({
    id: 1,
    date: '2024-9-3',
    content: 'Keep it up! Learn Node and build a small demo',
    collection: 5,
    comment: 8,
    userName: 'Anonymous'
  })
