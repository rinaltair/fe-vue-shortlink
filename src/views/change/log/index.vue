<template>
  <div class="page-content">
    <h3 class="table-title"><i class="iconfont-sys">&#xe74d;</i>Changelog</h3>

    <!-- Desktop table view -->
    <div class="desktop-view">
      <ArtTable :data="upgradeLogList">
        <ElTableColumn label="Version" prop="version" width="100" />
        <ElTableColumn label="Content">
        ...
        <ElTableColumn label="Release Date" prop="date" width="150" />
        <ElTableColumn label="Remarks" prop="remark" width="260" />
      </ArtTable>
    </div>
        ...
        <div v-for="item in upgradeLogList" :key="item.version" class="changelog-card">
          ...
          <div class="card-content">
            ...
            <div v-if="item.requireReLogin" class="require-relogin">
              <ElTag type="warning" size="small"> Re-login required </ElTag>
            </div>
          </div>
        </div>
      </div>
